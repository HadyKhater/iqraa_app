      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            if(isEmailSelected ==true)   SizedBox(
                height: 32.0.h,
              ),
              if(isEmailSelected ==true)  const CustomTextFormFiled(
                type: TextInputType.emailAddress,
                maxlines: 1,
                hint: 'البريد المسجل به',
                iconDataPrefx: Icons.email,
              ),
                if(isEmailSelected ==false)   SizedBox(
                height: 32.0.h,
              ),
            if(isEmailSelected ==false)    const CustomTextFormFiled(
                type: TextInputType.emailAddress,
                maxlines: 1,
                hint: 'الفون',
